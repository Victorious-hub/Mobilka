...
@Composable
fun WeightConverterScreen(viewModel: WeightViewModel = hiltViewModel(), innerPadding: PaddingValues) {
    val textFieldValueUp = viewModel.textFieldValueUpState.value
    val textFieldValueDown = viewModel.textFieldValueDownState.value

    val options1 = listOf("Grams", "Kilograms", "Pounds", "Ounces")
    val options2 = listOf("Grams", "Kilograms", "Pounds", "Ounces")
            ...
            Column(
                ...
                ConverterRow(
                    ...
                    onOptionSelected = { option ->
                        ...
                        viewModel.updateWeight(selectedOption1, selectedOption)
                    },
